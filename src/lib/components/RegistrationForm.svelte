<script lang="ts">
    ...
    export let subtitle = "Let us know more about you";
    export let onSubmit = () => {};
    ...
    <form on:submit|preventDefault={handleSubmit}>
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <Input id="email" bind:value={formData.email} placeholder="adrian@jsmastery.pro" class="mt-1" />
            </div>
            <div>
            ...
            <div>
                ...
                <div class="mt-1 flex gap-4">
                    <label class="flex items-center gap-1">
                        <input type="radio" name="gender" value="male" bind:group={formData.gender} class="accent-blue-500" />
                        Male
                    </label>
                    <label class="flex items-center gap-1">
                        <input type="radio" name="gender" value="female" bind:group={formData.gender} class="accent-blue-500" />
                        Female
                    </label>
                    <label class="flex items-center gap-1">
                        <input type="radio" name="gender" value="other" bind:group={formData.gender} class="accent-blue-500" />
                        Other
                    </label>
                </div>
            </div>
            <div>
                ...
                <Input id="occupation" bind:value={formData.occupation} placeholder="Software Engineer" class="mt-1" />
            </div>
            <div>
                <Label for="address">Address</Label>
                <Input id="address" bind:value={formData.address} placeholder="ex: 14 street, New York, NY - 5101" class="mt-1" />
            </div>
            <div>
                <Label for="emergencyName">Emergency contact name</Label>
                <Input id="emergencyName" bind:value={formData.emergencyName} placeholder="Guardian's name" class="mt-1" />
            </div>
            <div>
                <Label for="emergencyPhone">Emergency Phone number</Label>
                <Input id="emergencyPhone" bind:value={formData.emergencyPhone} placeholder="ex: +1 (868) 579-9831" class="mt-1" />
            </div>
        </div>
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
                ...
                <Input id="physician" bind:value={formData.physician} placeholder="Dr. Adam Smith" class="mt-1" />
            </div>
            <div>
                <Label for="insurance">Insurance provider</Label>
                <Input id="insurance" bind:value={formData.insurance} placeholder="ex: BlueCross" class="mt-1" />
            </div>
            <div>
            ...
            <div>
                ...
                <Input id="allergies" bind:value={formData.allergies} placeholder="ex: Peanuts, Penicillin, Pollen" class="mt-1" />
            </div>
            <div>
            ...
            <div>
                ...
                <Input id="familyHistory" bind:value={formData.familyHistory} placeholder="ex: Mother had breast cancer" class="mt-1" />
            </div>
            <div>
                <Label for="pastHistory">Past medical history</Label>
                <Input id="pastHistory" bind:value={formData.pastHistory} placeholder="ex: Asthma diagnosis in childhood" class="mt-1" />
            </div>
        </div>
        <Separator class="my-2" />
        ...
        <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
                ...
                <Input id="idNumber" bind:value={formData.idNumber} placeholder="ex: 1234567" class="mt-1" />
            </div>
        ...
        <div class="mb-8 space-y-3">
            ...
            <label class="flex items-center gap-2">
                <input type="checkbox" bind:checked={formData.consents.disclosure} class="accent-blue-500" />
                <span
